...
// "Brittney — Social Media Voice" from the ElevenLabs Voice Library —
// the user auditioned and picked this one. NOTE: library voices must be
// added to the account's My Voices before the API can use them.
// Overridable via env without a code change; if this ID ever mismatches
// the account's copy, every attempt 404s and narration falls back to the
// browser voice — the tell is the robotic voice returning.
