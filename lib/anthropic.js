...
// Budget kept moderate: enough to recompute a school problem line by line,
// small enough that the call stays well inside the serverless function's
// 60s maxDuration (see vercel.json — the platform default of 10s was the
// first thing this feature tripped over).
const CHECK_THINKING = { type: 'enabled', budget_tokens: 2000 };
