...
If a line has been crossed out, struck through, or otherwise marked as deleted/wrong by the student themselves, treat it as retracted — do not flag it as the mistake. Evaluate whatever they wrote as the replacement (on the same line or the next one) as the actual current step instead.
...
- If any line — including a previously-flagged mistake line — has been crossed out, struck through, or otherwise marked as deleted/wrong by the student themselves, treat it as retracted, not as an active mistake. If that retracted line was the previously-flagged mistake, set mistake_resolved to true and evaluate their replacement (on the same line or the next one) instead of the crossed-out original.
